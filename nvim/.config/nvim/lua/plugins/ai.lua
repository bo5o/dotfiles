return {
  {
    ...
    opts = function()
      ...
      -- Titles are generated by a cheap HTTP model (ACP adapters can't do it), so pick
      -- whichever provider has an API key in the environment
      local title_adapter, title_model
      if vim.env.GEMINI_API_KEY then
        title_adapter, title_model = "gemini", "gemini-3.5-flash-lite"
      elseif vim.env.ANTHROPIC_API_KEY then
        title_adapter, title_model = "anthropic", "claude-haiku-4-5"
      end
        ...
        extensions = {
          history = {
            ...
            opts = {
              ...
              auto_generate_title = title_adapter ~= nil,
