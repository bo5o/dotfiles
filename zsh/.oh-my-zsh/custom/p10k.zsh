# Generated by Powerlevel10k configuration wizard on 2020-05-03 at 15:52 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_PYTHON_SHOW_ON_UPGLOB='*.py|requirements.txt|pyproject.toml'
  ...
  typeset -g POWERLEVEL9K_ASDF_HADOLINT_FOREGROUND=172
  typeset -g POWERLEVEL9K_ASDF_HADOLINT_VISUAL_IDENTIFIER_EXPANSION=''
  typeset -g POWERLEVEL9K_ASDF_HADOLINT_SHOW_ON_UPGLOB='Dockerfile'
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_GENERIC_NAMES=(virtualenv venv .venv env python-3.7.7)
