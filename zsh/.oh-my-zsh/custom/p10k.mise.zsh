...
() {
  ...
  # OpenTofu version from mise.
  typeset -g POWERLEVEL9K_MISE_OPENTOFU_FOREGROUND='#d3869b'
  typeset -g POWERLEVEL9K_MISE_OPENTOFU_VISUAL_IDENTIFIER_EXPANSION='󱁢 '
  # typeset -g POWERLEVEL9K_MISE_OPENTOFU_SHOW_ON_UPGLOB='*.foo|*.bar'

  # Ansible version from mise.
  typeset -g POWERLEVEL9K_MISE_ANSIBLE_FOREGROUND='#ea6962'
  typeset -g POWERLEVEL9K_MISE_ANSIBLE_VISUAL_IDENTIFIER_EXPANSION='󱂚 '
  # typeset -g POWERLEVEL9K_MISE_ANSIBLE_SHOW_ON_UPGLOB='*.foo|*.bar'
